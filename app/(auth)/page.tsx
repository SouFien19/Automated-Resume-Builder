    ...
    <div>
      ...
      <footer className="backdrop-blur-md w-full">
        <div className="w-full mx-auto text-center max-w-screen-xl p-4 flex max-md:flex-col md:items-center md:justify-between">
          ...
          <Link
            href="https://www.linkedin.com/in/soufiane-Labiadh"
            className="group flex items-center gap-2 text-gray-500 text-sm font-medium hover:text-primary-500 transition-colors duration-300 me-4 md:me-6"
            target="_blank"
            rel="noopener noreferrer"
          >
          <span className="mt-3 sm:mt-0 transition-transform duration-300 group-hover:scale-105">
            Made with
          </span> 
          <span className="text-red-500 transition-transform duration-300 group-hover:animate-bounce">
            ❤️
          </span>
